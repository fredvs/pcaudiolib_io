...
int
xaudio2_object_openrec(struct audio_object *object,
                    enum audio_object_format format,
                    uint32_t rate,
                    uint8_t channels)
{
...
int
xaudio2_object_read(struct audio_object *object,
                     void *data,
                     size_t bytes)
{
	struct xaudio2_object *self = to_xaudio2_object(object);
